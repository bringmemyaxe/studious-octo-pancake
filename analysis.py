...
kick_values = analyse("./ref_sounds/ref_sound1.wav")
snare_values = analyse("./ref_sounds/ref_sound2.wav")
hihat_values = analyse("./ref_sounds/ref_sound3.wav")
open_values = analyse("./ref_sounds/ref_sound4.wav")
